<div class="modal fade" id="createSysadminAccount" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabelSysad" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <form action="{{route('accountStore')}}" method="POST">
            ...
            <div class="modal-body">
                <input type="hidden" name="role" value="sysadmin">
                
                
                    {{-- system admin form --}}
                    <div id="systemadminform" >
                        <div class="mt-3 mb-3">
                            <div class="row">
                                <div class="col-4">
